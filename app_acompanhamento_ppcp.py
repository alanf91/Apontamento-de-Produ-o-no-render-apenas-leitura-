# VERSÃO 4.3: melhora o contraste e a legibilidade do Calendário Semanal em temas claro e escuro.
...
def renderizar_tabela_calendario_semanal(
    ...
    datas_semana = [inicio + timedelta(days=i) for i in range(7)]
...
def renderizar_calendario_semanal(df: pd.DataFrame, caminho: Path) -> None:
    ...
    st.caption(
        ...
        "do setor naquele dia e a última coluna consolida a semana."
    )
    ...
    referencia = col_data.date_input(
        ...
        help="O sistema exibirá de segunda-feira a domingo da semana escolhida.",
    )
    ...
    st.info(f"Semana exibida: **{inicio:%d/%m/%Y} a {fim:%d/%m/%Y}**.")
    ...
    st.caption(
        ...
        "÷ quantidade programada na semana."
    )
